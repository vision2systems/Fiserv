...
namespace Vision.Vault.Treasury.Afnis.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditorAgent :  IEquatable<CreditorAgent>
    {
        /// <summary>
        ...
        public CreditorAgent(string clearingSystemIdentification = default(string), string memberIdentification = default(string))
        {
            // to ensure "clearingSystemIdentification" is required (not null)
            if (clearingSystemIdentification == null)
            {
                throw new InvalidDataException("clearingSystemIdentification is a required property for CreditorAgent and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("memberIdentification is a required property for CreditorAgent and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreditorAgent);
        }

        /// <summary>
        /// Returns true if CreditorAgent instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditorAgent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditorAgent input)
        {
            if (input == null)
                return false;
