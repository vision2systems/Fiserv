...
namespace Vision.Vault.Treasury.Afnis.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Creditor" /> class.
        /// </summary>
        [JsonConstructor]
        protected Creditor() { }
        /// <summary>
        ...
        public Creditor(string identification = default(string), string name = default(string))
        {
            // to ensure "identification" is required (not null)
            if (identification == null)
            {
                throw new InvalidDataException("identification is a required property for Creditor and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as Creditor);
        }

        /// <summary>
        /// Returns true if Creditor instances are equal
        /// </summary>
        /// <param name="input">Instance of Creditor to be compared</param>
        /// <returns>Boolean</returns>
